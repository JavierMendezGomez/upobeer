...
$inputFields=["usuario","dni","nombre","apellidos","fechanacimiento","direccion","telefono"];
...
case "insert":
    $neededFields=["usuario","dni","nombre","apellidos","fechanacimiento","direccion","telefono"];
    ...
    //
    $sql="
insert into cliente ({$neededFieldsString})
